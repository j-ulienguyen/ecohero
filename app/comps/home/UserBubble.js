        ...
        <View style={styles.container}>
            ...
            <View>
                ...
                <View style={styles.bubbleContent}>
                    ...
                    <Text style={styles.heyUser}>Hey, hardcoreHenry!</Text>
                    <Text style={styles.missionText}>You have <Text style={styles.missionNumber}>30</Text> available missions</Text>
